...
from core.utils.research.model.layers import Indicators, DynamicLayerNorm, DynamicBatchNorm
...
class TrainerTest(unittest.TestCase):
	...
	def create_cnn():
		...
		FF_LINEAR_INIT = None
		FF_LINEAR_NORM = [DynamicBatchNorm()] + [DynamicLayerNorm() for _ in FF_LINEAR_LAYERS[:-1]]
