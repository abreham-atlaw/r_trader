...
AGENT_DISCOUNT_FACTOR_S = 7
AGENT_DISCOUNT_FUNCTION = lambda d: (1/(1+math.e**(d-AGENT_DISCOUNT_FACTOR_S)))*(1+math.e**(d-AGENT_DISCOUNT_FACTOR_S-1))
...
MAPLOSS_FS_MODELS_PATH = "/Apps/RTrader/maploss/it-60/"
