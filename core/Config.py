...
DROPBOX_API_TOKEN = "sl.Bqfjt4QwftCGLySPWVRc1kUYNkpBuTdi7C6l9mHWrS0hFs9Bvb0xhKrjrPPJWqHv3uRHLn19TEe-Y67oAv1SkJfOVEUd5pDAgihZc1Vyh943RURyj2azUj2CMevEfzufqGt1Y_FKHUbmtwzX1Mm4IWE"
...
CORE_MODEL_CONFIG = ModelConfig(
	...
	path=os.path.join(BASE_DIR, "temp/models/1700508499.667843.pt"),
	download=False
)
