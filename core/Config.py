...
OANDA_TRADING_ACCOUNT_ID = "101-001-19229086-004"
OANDA_TEST_ACCOUNT_ID = "101-001-19229086-004"
DEFAULT_TIME_IN_FORCE = "FOK"
TIMEZONE = timezone("Africa/Addis_Ababa")


# AGENT CONFIGS
MARKET_STATE_MEMORY = 137
TIME_PENALTY = 0
AGENT_TRADE_SIZE_GAP = 30
AGENT_DEPTH = 30
...
AGENT_COMMISSION_COST = 5 / 100000
CURRENCIES = [
	"AUD",
	"CAD",
	"CHF",
...
NEW_MODEL = False
MODEL_PATH = os.path.join(BASE_DIR, "res/model128_wrapped.h5")
