...
OANDA_SIM_DELTA_MULTIPLIER = 5
OANDA_SIM_MARGIN_RATE = 0.01
OANDA_SIM_BALANCE = 100
OANDA_SIM_ALIAS = "Sim Account 0"
OANDA_SIM_TIMES_PATH = os.path.join(BASE_DIR, "res/times/times-10.json")
...
MAPLOSS_FS_MODELS_PATH = "/Apps/RTrader/maploss/it-39/"
...
AGENT_STEP_TIME = (6 * 60) - AGENT_FRICTION_TIME
MARKET_STATE_GRANULARITY = "M30"
UPDATE_AGENT = True
UPDATE_EXPORT_BATCH_SIZE = 2
