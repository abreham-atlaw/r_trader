...
UPDATE_TRAIN = False
MARKET_STATE_MA_WINDOW_SIZE = 64
MARKET_STATE_MEMORY = 1024 + MARKET_STATE_MA_WINDOW_SIZE - 1
MARKET_STATE_USE_MA = False
MARKET_STATE_USE_CMA = not MARKET_STATE_USE_MA
...
AGENT_MA_WINDOW_SIZE = MARKET_STATE_MA_WINDOW_SIZE
...
class RunnerStatsBranches:
	...
	default = ma_cma_dynamic_k_stm_it_27
